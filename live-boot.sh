...
current_positions_customized=$(python3 -c "import json; print('true' if json.load(open('$config_path')).get('positionsCustomized') else 'false')" 2>/dev/null || echo "false")
